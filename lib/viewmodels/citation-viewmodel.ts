...
const CITATION_FORMATS: CitationFormats = {
  ...
  ieee: {
    ...
    example:
      'A. Author, "Title of article," Journal Name, vol. #, no. #, pp. #-#, Year.',
  },
  harvard: {
    id: 'harvard',
    name: 'Harvard Style',
    ...
    example:
      "Author, A. (Year) 'Title of article', Journal Name, vol. #, no. #, pp. #-#.",
  },
  bibtex: {
    id: 'bibtex',
    name: 'BibTeX',
...
export class CitationViewModel {
  ...
  constructor(
    initialState: CitationState,
    setState: (state: CitationState) => void
  ) {
  ...
  get generatedCitations() {
    return this.state.generatedCitations
  }
  get isGenerating() {
  ...
  get selectedPapers() {
    return this.state.selectedPapers
  }
